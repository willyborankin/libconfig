...
public class ConfigParser implements ConfigParserConstants {
  ...
  final public Config buildConfiguration() throws ParseException {parserCtx = new ParserContext(new Config());
    ...
    jj_consume_token(0);
{if ("" != null) return parserCtx.getConfig();}
...
if (values != null) {
  ...
  final private void arrayValue(String name) throws ParseException {ArrayList<Object> values = new ArrayList<Object>();
...
parserCtx.addArraySetting(name, values.toArray(new Object[values.size()]));
  ...
  final private void listValue(String name) throws ParseException {Setting listSetting = parserCtx.addListSetting(name);
...
parserCtx.setParent(listSetting.getParent());
  ...
  final private void groupValue(String name) throws ParseException {Setting groupSetting = parserCtx.addGroupSetting(name);
