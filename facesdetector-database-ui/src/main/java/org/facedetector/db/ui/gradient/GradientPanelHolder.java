package org.facedetector.db.ui.gradient;
...
public class GradientPanelHolder extends JPanel {
	
	private static final long serialVersionUID = -2675605498478204622L;
	...
	/**
	 * Constructs a SimpleInternalFrame with the specified title. The title is
	 * intended to be non-blank, or in other words should contain non-space
	 * characters.
	 * 
	 * @param title
	 *            the initial title
	 */
	public GradientPanelHolder(String title) {
	 ...
	 *            the initial title
	 */
	public GradientPanelHolder(Icon icon, String title) {
	 ...
	 */
	public GradientPanelHolder(String title, JToolBar bar, JComponent content) {
	 ...
	 *            the initial content pane
	 */
	public GradientPanelHolder(Icon icon, String title, JToolBar bar,
			JComponent content) {
	...
	protected Color getTextForeground(boolean isSelected) {
		...
		return UIManager
				.getColor(isSelected ? "InternalFrame.activeTitleForeground" : "Label.foreground");
	...
	private static class RaisedHeaderBorder extends AbstractBorder {
		private static final long serialVersionUID = -4270683672466205916L;
	...
	private static class ShadowBorder extends AbstractBorder {
		private static final long serialVersionUID = -5590119298040277202L;
...
//			}
	...
	private static final class GradientPanel extends JPanel {
		private static final long serialVersionUID = 644220286340107535L;
