...
public class IncidentInfo {
    ...
    private static final Integer ERROR_HEADER_SIZE = 100;
    /**
    ...
    public IncidentInfo(String header, String basicErrorMessage,
		...
		this.basicErrorMessage = trunkateString(this.basicErrorMessage, ERROR_HEADER_SIZE);
	...
	public String trunkateString(String string, Integer numberOfLiters) {
		if (string == null) {
			return "Oooops...";
		}
		if (string.length() <= numberOfLiters){
			return string;
		}
		return string.substring(0, numberOfLiters) + " ...";
	}
}